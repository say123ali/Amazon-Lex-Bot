...
def sendemail():
    try:
        if request.json['emailid'] is not None:
            ...
            contact_add = "sayali.sk333@gmail.com"  ## the email id of the support team
            fromaddr = "salunkesayali02@gmail.com"   ## the email id from where we are going to send the mail
            ...
            # Authentication
            s.login(fromaddr, "sayali12345")  # give your password here
